...
cfg.announces = {
  ["admin"] = {
    --image = "nui://cRP_mod/announce_admin.png",
  ...
  ["police"] = {
    --image = "nui://cRP_mod/announce_police.png",
  ...
  ["commercial"] = {
    --image = "nui://cRP_mod/announce_commercial.png",
    image = "http://i.imgur.com/b2O9WMa.png",
    description = "Commercial stuff (buy, sell, work).",
    price = 5000
  },
  ["party"] = {
    --image = "nui://cRP_mod/announce_party.png",
