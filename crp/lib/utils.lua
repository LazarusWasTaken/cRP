-- this file define global tools required by cRP and cRP extensions
...
function module(rsc, path)
  if path == nil then -- shortcut for cRP, can omit the resource parameter
    path = rsc
    rsc = "cRP"
  end
...
local Debug = module("cRP", "lib/Debug")
